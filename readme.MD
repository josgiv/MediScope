...
3. **Quick Checkup**: Hosted on `http://localhost:5010/quick-checkup`

### Main API
The main Flask app, hosted on `http://localhost:5000/full-checkup`, communicates with these three models and aggregates the results.
