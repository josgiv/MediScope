...
MODEL_PATH = os.path.join(BASE_DIR, "../../assets/models/quick_checkup/rf_QuickCheckup.joblib")
SYMP_DESC_PATH = os.path.join(BASE_DIR, "../../notebooks/datasets/quick_checkup/symptom_Description.csv")
SYMPTOM_PRECAUTION_PATH = os.path.join(BASE_DIR, "../../notebooks/datasets/quick_checkup/symptom_precaution.csv")
SYMP_SEVERITY_PATH = os.path.join(BASE_DIR, "../../notebooks/datasets/quick_checkup/Symptom-severity.csv")
